<?php
function mpm_dashboard_widget() {

	if ( current_user_can( 'edit_dashboard' ) ) {

		wp_add_dashboard_widget( 'mpmdashbordwidget',
			__( 'MPM Widgets', 'dashboardwidget' ),
			'mpm_dashboardwidget_output',
			'mpm_dashboardwidget_configure'
		);
...
add_action( 'wp_dashboard_setup', 'mpm_dashboard_widget' );

function mpm_dashboardwidget_output(){
    ...
    $count_output = <<<EOD
        <div class="main">
            ...
            <h2 class="hndle ui-sortable-handle">Develop By : Md. Redoy Islam</h2>	
        </div>
    EOD;
    echo $count_output;
